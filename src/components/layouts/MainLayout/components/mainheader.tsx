          ...
          <>
            ...
            >
              <div className="flex flex-col items-start p-5 space-y-4">
                ...
                <Link href={"#clients-section"} onClick={closeMenu}>
                  {t("nav.clients")}
                </Link>
                ...
                <Link href={"#projects-section"} onClick={closeMenu}>
                  {t("nav.projects")}
                </Link>
                <button
                  onClick={() => {
...
//             <button
//               onClick={handleScrollToContact}
//               className="bg-[#2f3fe7] rounded-[7px] text-[#fff] text-[14px] font-bold py-2 px-4 hidden md:block"
//             >
//               {t("nav.contact")}
//             </button>
...
//             {/* Mobile Menu */}
//             <div
//               className={`fixed top-0 right-0 h-full w-[250px] bg-[#121637] text-white transition-transform duration-300 ease-in-out transform z-50 ${
//                 menuOpen ? "translate-x-0" : "translate-x-full"
//               } md:hidden`}
//             >
//               <div className="flex flex-col items-start p-5 space-y-4">
...
//                   </svg>
//                 </button>
//                 <Link href={"#home-section"} onClick={closeModal}>
//                   {t("nav.home")}
//                 </Link>
//                 <Link href={"/#"} onClick={closeModal}>
//                   {t("nav.about")}
//                 </Link>
//                 <Link href={"#clients-section"} onClick={closeModal}>
//                   {t("nav.clients")}
//                 </Link>
//                 <Link href={"#services-section"} onClick={closeModal}>
//                   {t("nav.services")}
//                 </Link>
//                 <Link href={"#tools-section"} onClick={closeModal}>
//                   {t("nav.tools")}
//                 </Link>
//                 <Link href={"#projects-section"} onClick={closeModal}>
//                   {t("nav.projects")}
//                 </Link>
